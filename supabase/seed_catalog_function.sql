...
as $$
  ...
  values
    ...
    (p_family_id, 'Cuidar da roupa da escola do dia seguinte', 'individual', null, 'diaria', 4, 1, 0.15, 1),
    (p_family_id, 'Pendurar a própria toalha de banho', 'individual', null, 'diaria', 1, 1, 0.05, 1),
    (p_family_id, 'Guardar objetos pessoais usados no dia', 'individual', null, 'diaria', 5, 1, 0.20, 1),
    ...
    (p_family_id, 'Organizar brinquedos e objetos pessoais', 'individual', null, 'diaria', 5, 1, 0.20, 1),
    (p_family_id, 'Lavar/guardar o próprio prato', 'individual', null, 'diaria', 2, 1, 0.10, 3),
    (p_family_id, 'Trocar a roupa de cama pessoal', 'individual', null, 'semanal', 10, 2, 0.50, 1),
    (p_family_id, 'Separar roupas para lavar', 'individual', null, 'semanal', 5, 1, 0.20, 1),
    (p_family_id, 'Lavar a própria roupa (máquina)', 'individual', null, 'semanal', 10, 3, 0.55, 1),
    (p_family_id, 'Secar a própria roupa', 'individual', null, 'semanal', 10, 2, 0.50, 1),
    (p_family_id, 'Dobrar a própria roupa', 'individual', null, 'semanal', 15, 2, 0.70, 1),
    (p_family_id, 'Guardar a própria roupa limpa no lugar', 'individual', null, 'semanal', 10, 1, 0.40, 1),
    (p_family_id, 'Manter o próprio skate e EPIs higienizados', 'individual', null, 'semanal', 10, 2, 0.50, 1),
    (p_family_id, 'Lavar toalhas de banho', 'individual', null, 'semanal', 10, 2, 0.50, 1),
    (p_family_id, 'Trocar toalhas de banho', 'individual', null, 'semanal', 5, 1, 0.20, 1),
    (p_family_id, 'Guardar toalhas limpas', 'individual', null, 'semanal', 5, 1, 0.20, 1),

    -- Individual-coletivas (valor já por menino)
    (p_family_id, 'Manter o quarto arrumado no geral', 'individual_coletiva', null, 'diaria', 5, 1, 0.25, 1),
    (p_family_id, 'Arejar o quarto', 'individual_coletiva', null, 'diaria', 1, 1, 0.05, 1),
    (p_family_id, 'Varrer e passar pano no chão do quarto', 'individual_coletiva', null, 'semanal', 10, 2, 0.60, 1),
    (p_family_id, 'Organizar o guarda-roupa compartilhado', 'individual_coletiva', null, 'semanal', 15, 3, 1.05, 1),
    (p_family_id, 'Organizar objetos/brinquedos comuns do quarto', 'individual_coletiva', null, 'semanal', 10, 2, 0.60, 1),
